<?php
/**
 * Widget API: ATC_Widget_Tag_Cloud class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
...
/**
 * Class used to implement a Accessible Tag cloud widget.
 *
 * @since 2.8.0
 *
 * @see WP_Widget
 */
class ATC_Tag_Cloud extends WP_Widget {

	/**
	 * Sets up a new Accessible Tag Cloud widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 */
	...
	/**
	 * Outputs the content for the current Accessible Tag Cloud widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 *
	 ...
	 * @param array $instance Settings for the current Accessible Tag Cloud widget instance.
	 */
	...
	/**
	 * Handles updating settings for the current Accessible Tag Cloud widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 *
	...
	/**
	 * Outputs the Accessible Tag Cloud widget settings form.
	 *
	 * @since 2.8.0
	 * @access public
	 *
	...
	/**
	 * Retrieves the taxonomy for the current Accessible Tag cloud widget instance.
	 *
	 * @since 4.4.0
	 * @access public
	 *
